...
namespace ZplHttpServer.Service
{
    public partial class ZplHttpServerService : ServiceBase
    {
        ...
        public ZplHttpServerService()
        {
            ...
            dataServer = new TcpServer("127.0.0.1", 0);
        ...
        private Process CreateDCProcess(string port)
        {
            ...
            psi.FileName = "ZplHttpServer.exe";
        ...
        private void watchDCTimerElapsed(object sender, ElapsedEventArgs e)//this type of timer is running by main thread
        {
            ...
            try
            {
                ...
                {
                    Log("Renew ZplHttpServer.exe");
                    mainSDCProc = CreateDCProcess(dataServer.ActualPort.ToString());
                    Log("Renew ZplHttpServer.exe successfully.");
                }
            }
            catch { }
            watchDCTimer.Start();
